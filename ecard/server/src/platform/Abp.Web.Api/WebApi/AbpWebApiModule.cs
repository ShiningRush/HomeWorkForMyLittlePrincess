...
using Yiban.CoreService.Web.Api.WebApi.ExceptionHandling;
using System.Web.Http.ExceptionHandling;
using Yiban.CoreService.Web.Api.WebApi.Authorization;
...
namespace Abp.WebApi
{
    ...
    public class AbpWebApiModule : AbpModule
    {
        ...
        private void InitializeAspNetServices(HttpConfiguration httpConfiguration)
        {
            ...
            // *King 
            httpConfiguration.Services.Replace(typeof(IExceptionHandler), IocManager.Resolve<GlobalApiExceptionHandler>());
        }

        private void InitializeFilters(HttpConfiguration httpConfiguration)
        {
            // *King
            httpConfiguration.Filters.Add(IocManager.Resolve<GatewayAuthorizeAttribute>());
        ...
        private static void InitializeFormatters(HttpConfiguration httpConfiguration)
        {
            ...
            httpConfiguration.Formatters.JsonFormatter.SerializerSettings.DateTimeZoneHandling = Newtonsoft.Json.DateTimeZoneHandling.Local;
        ...
        private static void InitializeRoutes(HttpConfiguration httpConfiguration)
        {
            ...
            httpConfiguration.Routes.MapHttpRoute(
                ...
                routeTemplate: "api/{*serviceNameWithAction}"
                );
